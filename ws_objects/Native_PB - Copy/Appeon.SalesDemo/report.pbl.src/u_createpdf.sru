...
ls_multi +=" *Merging the PDFs generated for DataWindows with existing PDF file (this     ~r~n    cover page),and images.~r~n"
...
lpdf_titlepage.setbottommargin(200 )
lpdf_titlepage.setrightmargin( 5)
